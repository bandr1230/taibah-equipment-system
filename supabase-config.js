// إعدادات Supabase للتجربة المشتركة - v5.6.8
// تم ضبط API URL الصحيح من Supabase Data API.
...
window.DEMO_DISABLE_REMOTE_SYNC = false;
window.DEMO_LABEL = 'منصة التجهيزات التعليمية';
